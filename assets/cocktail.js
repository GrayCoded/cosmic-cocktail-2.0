var cocktailDescriptionEl = document.querySelector('.description');
var cocktailNameEl =document.querySelector('.drink-name')
var cocktailImgEl = document.querySelector('.drink-img');
var cocktailContainer = document.querySelector('.drink-cont')
...
// var requestApi = 'https://www.thecocktaildb.com/api/json/v2/9973533/filter.php?c=Cocktail';
//  var randomApi = 'https://www.thecocktaildb.com/api/json/v2/9973533/random&filter.php?c=Cocktail.php';
...
var requestApi = 'https://www.thecocktaildb.com/api/json/v2/9973533/randomselection.php';
 // var randomApi = 
 var idApi = 'https://www.thecocktaildb.com/api/json/v2/9973533/lookup.php?i=11007';
